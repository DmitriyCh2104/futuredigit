...
export default function SoftwareEngineeringPage() {
  ...
  const services = [
    {
      ...
      description: "Applications web et mobiles adaptees a vos besoins specifiques",
    },
    {
      icon: Layers,
    ...
    },
    {
      ...
      description: "Connexion fluide entre vos differentes applications",
    },
    {
      icon: GitBranch,
  ...
  const benefits = [
    "Equipes expertes certifiees",
    "Methodologies agiles",
    "Code de haute qualite",
    "Support continu",
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 text-pretty">
              Nous concevons et developpons des solutions logicielles innovantes et performantes, 
              adaptees aux defis uniques de votre entreprise.
            </p>
            <Link href="/#contact">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Une gamme complete de services pour repondre a tous vos besoins en developpement logiciel
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Pret a transformer vos idees en realite?
            </h2>
            <p className="text-muted-foreground mb-8">
