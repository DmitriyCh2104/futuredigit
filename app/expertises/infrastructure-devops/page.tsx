  ...
  const services = [
    {
      ...
      description: "Pipelines de deploiement continu automatises",
    },
    {
      icon: Container,
    ...
    },
    {
      ...
      description: "Surveillance proactive de vos systemes",
    },
    {
      icon: GitMerge,
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 text-pretty">
              Automatisez vos deploiements, optimisez votre infrastructure et accelerez 
              votre cycle de developpement avec nos experts DevOps.
            </p>
            <Link href="/#contact">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground mb-8">
                Notre equipe DevOps experimente transforme vos operations IT pour plus 
                d'agilite, de fiabilite et de performance.
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">
              ...
              transformer votre cycle de developpement.
            </p>
            <Link href="/#contact">
              <Button size="lg" className="bg-foreground text-background hover:bg-foreground/90">
                Contactez-nous
