...
export default function SAPPage() {
  ...
  const services = [
    {
      icon: Database,
      title: "Implementation SAP",
      description: "Deploiement et configuration de solutions SAP",
    },
    {
      icon: Workflow,
      title: "Integration",
      description: "Connexion de SAP avec vos systemes existants",
    },
    {
      icon: RefreshCw,
      title: "Migration S/4HANA",
      description: "Transition vers la nouvelle generation SAP",
    },
    {
      icon: Cog,
      title: "Support & Maintenance",
      description: "Assistance technique et evolution continue",
    },
  ]

  const benefits = [
    "Consultants certifies SAP",
    "Expertise multi-modules",
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 text-pretty">
              Nos consultants SAP certifies vous accompagnent dans l'implementation, 
              l'integration et l'evolution de vos solutions SAP.
            </p>
            <Link href="/#contact">
      ...
      <section className="py-24 bg-[#020817]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Nos Services SAP</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Un accompagnement complet sur l'ensemble de l'ecosysteme SAP
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground mb-8">
                Nos experts SAP maitrisent l'ensemble des modules et vous accompagnent 
                dans votre transformation digitale avec SAP.
              </p>
            ...
            >
              <img
                src="/images/expertise-sap-2.jpg"
                alt="SAP consulting"
